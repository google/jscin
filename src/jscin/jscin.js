...
export const IMKEY_BELL   = 0x4;
export const IMKEY_BELL2  = 0x8;
export const IMKEY_ERROR  = 0x20;
export const IMKEY_DELAY  = 0x21;
export const IMKEY_UNKNOWN= 0x101;
...
jscin.IMKEY_BELL   = IMKEY_BELL;
jscin.IMKEY_BELL2  = IMKEY_BELL2;

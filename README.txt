...
your favorite input method everywhere. Moreoever, ChromeOS does not allow
installing userland native programs.

Chrome browser now supports an "extension API" (still experimental):
